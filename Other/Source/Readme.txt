...
user in an INI file next to FotoSketcherPortable.exe called FotoSketcherPortable.ini.
...
copy AppNamePortable.ini from this directory to FotoSketcherPortable.ini next to
FotoSketcherPortable.exe. The options in the INI file are as follows:
